...
public class ExtractApiController implements ExtractApi {
    ...
    public ResponseEntity<Void> extract(@Parameter(in = ParameterIn.PATH, description = "Repo path of architecture models", required=true, schema=@Schema()) @PathVariable("projectrepoPath") String projectrepoPath
) {
